...
import RediantQuote from "../components/core/AboutPage/RediantQuote";
import Footer from "../components/commonCodeandPage/Footer";
import LearningPathGrid from "../components/core/AboutPage/LearningPathGrid";
        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">
              Study Adda is at the forefront of driving innovation in online
          ...
          <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-2">
            <img src={about1} alt="" />
            <img src={about2} alt="" />
            <img src={about3} alt="" />
          </div>
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          <div className="flex flex-col items-center gap-6 lg:flex-row justify-evenly">
            <div className="my-24 flex lg:w-[50%] flex-col gap-10">
              <h1 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] mt-3 ">
                Our Founding Story
              </h1>
