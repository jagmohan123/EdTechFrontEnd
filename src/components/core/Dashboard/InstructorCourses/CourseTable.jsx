...
function CourseTable({ courses, setCourses }) {
  ...
  return (
    <>
              ...
              >
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    {/* condition ke base me draft or publish ke icon bhi aa rhe hai */}
                ...
                <Td className="text-sm font-medium text-richblack-100 ">
                  <button
                    disabled={loading}
                    // parameter me id send kar deaye eske basis me ham course edit karenge
                    onClick={() => {
      ...
      {/* agar mere confirmation modal me data hai to me use render karaunga  */}
