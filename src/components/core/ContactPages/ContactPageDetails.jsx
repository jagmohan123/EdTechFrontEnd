...
const contactDetails = [
  ...
  },
  {
    ...
    details:
      "Shanti Nagar 1st Block 1st Cross, Deendayal Chouk, Jabalpur-482002",
  },
  {
    icon: "IoCall",
    heading: "Call us",
    description: "Mon - Fri From 8am to 5pm",
    details: "+91-8223011820",
  },
];

function ContactPageDetails() {
  return (
    <div className="flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6 mb-10">
